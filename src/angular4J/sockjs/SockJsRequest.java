...
/**
 * In addition to the abstract methods, implementations are expected to call onDataHandler.handle
 * and onEndHandler.handle when there is request data available and when the request has ended,
 * respectively.
 */
